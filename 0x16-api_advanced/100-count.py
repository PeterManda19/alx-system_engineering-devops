...
def count_words(subreddit: str, word_list: list[str], count_dict=None, after=None):
    """
    ...
    Args:
        ...
        count_dict (dict): Dictionary to store the word counts
        after (str): Value of the 'after' parameter in the Reddit API response
    ...
    for title in titles:
        for word in count_dict:
            count_dict[word] += len(re.findall(rf"\b{word}\b", title))
